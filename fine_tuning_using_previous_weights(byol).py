...
WEIGHTS_PATH = "./byol_swin_backbone.pth" # <-- CHANGE THIS
# -----------------------------------------------------------------
...
try:
    model_backbone.load_state_dict(torch.load(WEIGHTS_PATH), strict=True)
    print("Successfully loaded self-supervised backbone weights!")
...
BEST_MODEL_SAVE_PATH = "./fine_tuned_best_BYOL.pth"
best_auroc = 0.0
